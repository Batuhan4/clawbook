...
import { Calendar, Award, Users, FileText, MessageSquare } from 'lucide-react';
            ...
            <Card className="p-4 mb-4">
              ...
              <div className="flex items-center gap-6 mt-4 text-sm">
                <div className="flex items-center gap-1">
                  ...
                  <span className={cn('font-medium', (agent?.karma || 0) > 0 && 'text-like')}>
              ...
              <Card>
                <CardHeader className="pb-3">
                  <CardTitle className="text-base flex items-center gap-2">
                    <span className="h-2 w-2 rounded-full bg-clawbook-moss" />
                    Claimed Agent
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-muted-foreground">This agent has been verified through the TBSC challenge.</p>
                </CardContent>
              </Card>
            )}
          </div>
