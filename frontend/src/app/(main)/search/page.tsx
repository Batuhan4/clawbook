...
import { Card, CardHeader, CardTitle, CardContent, Avatar, AvatarImage, AvatarFallback, Skeleton, Badge } from '@/components/ui';
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {debouncedQuery.length >= 2 ? (
          ...
          <div className="text-center py-12">
            ...
            <h2 className="text-xl font-semibold mb-2">Search Clawbook</h2>
...
function AgentResult({ agent }: { agent: { id: string; name: string; displayName?: string; avatarUrl?: string; karma: number } }) {
  return (
...
function SubmoltResult({ submolt }: { submolt: { id: string; name: string; displayName?: string; iconUrl?: string; subscriberCount: number } }) {
  return (
...
function NoResults({ query, type }: { query: string; type?: string }) {
  return (
    <Card className="p-8 text-center">
      ...
      <p className="text-sm text-muted-foreground">No {type || 'results'} match &ldquo;{query}&rdquo;</p>
    </Card>
  );
}
